...
# ============================================================
# FEATURE ENGINEERING — HISTORIQUE CLIENT
# ============================================================

# Taux d'annulation historique
#
# Si le client n'a aucune réservation passée,
# on met 0 car il n'y a aucune annulation connue.

df["taux_annulation_historique"] = np.where(
    df["reservations_passees"] > 0,

    df["annulations_passees"]
    / df["reservations_passees"],
...
df["client_sans_historique"] = (
    df["reservations_passees"] == 0
).astype(int)


# Nombre de réservations passées qui n'ont pas été annulées
df["reservations_non_annulees"] = (
    df["reservations_passees"]
    - df["annulations_passees"]
)
...
numeriques = [
    ...
    # Nouvelles features historiques
    "taux_annulation_historique",
    "client_sans_historique",
    "reservations_non_annulees"
]
...
print("\n" + "=" * 60)
print("RESULTATS — HISTORIQUE CLIENT")
print("=" * 60)
