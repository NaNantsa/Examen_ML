...
# Combinaison :
# tarif_remboursable + type_acompte

df["flexibilite_reservation"] = (
    df["tarif_remboursable"].fillna("inconnu")
    + "_"
    + df["type_acompte"].fillna("inconnu")
)


print("=" * 60)
print("NOUVELLE FEATURE")
print("=" * 60)

print(
    df["flexibilite_reservation"].value_counts(
        dropna=False
    )
)
